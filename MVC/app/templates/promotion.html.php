    ...
    <div class="milieu-po">
        ...
        <div class="promo_list">
            ...
            <div class="search_bar"
                style="position: absolute;display: flex; align-items: center;height: 15%;width: 20%; border-radius: 0.2vw;left: 65%; top: 8%;">
                <input class="text-rech" type="text" placeholder="Rechercher ici..."
                    style="position: absolute; left: 1%; width: 86%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    ...
                                    <button class="btneditpromo" type="submit"
                                        style="width:100%;background-color:transparent;border:none;width:2vw;heigth:2vh">
                                        <i
                                            class="<?= $promo['etat'] === 'activer' ? "fa-sharp fa-thin fa-square-check editicon fa-solid" : "fa-sharp fa-thin fa-square editicon fa-solid" ?>"></i>
                                    </button>
                                </form>
                            </td>
                        </tr>
